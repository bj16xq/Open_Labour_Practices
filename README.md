...
For a theoretical background on OPOL and the contents of this repository, see the [OSF project page](https://osf.io/kfzns). For open content in other domains, please see the respective repositories: [open co-curricular practices](https://github.com/bj16xq/Open_Co-curricular_Practices) and [open scholarship](https://github.com/bj16xq/BJ_Open_Scholarship) (open pedagogy, open science/research, and open content for students).
